...
(function ($, Adventure) {
    ...
    self.exportStory = function() {
      // copy the story object and get rid of _id and _rev for export
      var story_copy = $.parseJSON(ko.toJSON(ko.mapping.toJS(self.story)));
      delete story_copy._id;
      delete story_copy._rev;
      window.open('data:text/json,' + ko.toJSON(ko.mapping.toJS(story_copy)), '_blank');
    }
